...
RSpec.describe VerificationsController, type: :controller do
  ...
  # Verification. As you add validations to Verification, be sure to
  ...
  # VerificationsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested verification as @verification" do
      verification = Verification.create! valid_attributes
      get :show, params: {id: verification.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested verification as @verification" do
      verification = Verification.create! valid_attributes
      get :edit, params: {id: verification.to_param}, session: valid_session
      expect(assigns(:verification)).to eq(verification)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Verification" do
        expect {
          post :create, params: {verification: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved verification as @verification" do
        post :create, params: {verification: invalid_attributes}, session: valid_session
        expect(assigns(:verification)).to be_a_new(Verification)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested verification" do
        verification = Verification.create! valid_attributes
        put :update, params: {id: verification.to_param, verification: new_attributes}, session: valid_session
        verification.reload
      ...
      it "assigns the requested verification as @verification" do
        verification = Verification.create! valid_attributes
        put :update, params: {id: verification.to_param, verification: valid_attributes}, session: valid_session
        expect(assigns(:verification)).to eq(verification)
      end
    ...
    context "with invalid params" do
      it "assigns the verification as @verification" do
        verification = Verification.create! valid_attributes
        put :update, params: {id: verification.to_param, verification: invalid_attributes}, session: valid_session
        expect(assigns(:verification)).to eq(verification)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested verification" do
      verification = Verification.create! valid_attributes
      expect {
        delete :destroy, params: {id: verification.to_param}, session: valid_session
      }.to change(Verification, :count).by(-1)
    end
