...
var WebSlides = function () {
  ...
  function WebSlides() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        minWheelDelta = _ref$minWheelDelta === undefined ? 180 : _ref$minWheelDelta,
        _ref$scrollWait = _ref.scrollWait,
        scrollWait = _ref$scrollWait === undefined ? 850 : _ref$scrollWait,
...
var Hash = function () {
  ...
  _createClass(Hash, [{
    ...
    value: function setSlideNumber(number) {
      ...
      /* Set the active slide panel item */
      var path = window.location.href; 
      $('#slider a.selector').removeClass('active');
